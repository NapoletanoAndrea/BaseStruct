...
{
    public static IEnumerator TransformPositionLerpCoroutine(Transform targetTransform, Vector3 startVector, Vector3 finalVector,
    ...
    public static ParticleSystem.MinMaxCurve LerpMinMaxCurves(ParticleSystem.MinMaxCurve a, ParticleSystem.MinMaxCurve b, float t)
    {
        ParticleSystem.MinMaxCurve lerpedCurve = a;
        lerpedCurve.constant = Mathf.Lerp(a.constant, b.constant, t);
        lerpedCurve.constantMin = Mathf.Lerp(a.constantMin, b.constantMin, t);
        lerpedCurve.constantMax = Mathf.Lerp(a.constantMax, b.constantMax, t);
        return lerpedCurve;
    }
    ...
    public static bool HasTimelineClipEnded(Playable playable, FrameData info)
    {
    ...
    public static ScriptableRendererData[] GetAllScriptableRendererData()
    {
        ...
        return (ScriptableRendererData[]) propertyInfo.GetValue(asset);
    }
